layui.define(['element'], function(exports){
   var  element = layui.element(),
         ...
         * [参数设置 options]
         */
        yyfTab.prototype.set = function(options){
              var _this = this;
         ...
         */
        yyfTab.prototype.init  = function(){
             var _this = this;
         ...
         */
        yyfTab.prototype.exists = function(title){
         ...
         * @return {[type]}      [description]
         */
        yyfTab.prototype.tabAdd = function(data){
            var _this = this;
		    var tabIndex = _this.exists(data.title);
		    // 若不存在
		    if(tabIndex === -1){
		    	globalTabIdIndex++;
		    	var content = '<iframe src="' + data.href + '" data-id="' + globalTabIdIndex + '" class="yyf-iframe"></iframe>';
			    var title = '';
			    // 若icon有定义
